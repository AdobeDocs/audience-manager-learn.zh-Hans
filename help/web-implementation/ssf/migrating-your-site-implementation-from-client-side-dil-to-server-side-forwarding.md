...
如果您使用的是非AdobeTMS，或根本没有TMS，则请实施ECID以在&#x200B;**任何其他Adobe解决方案之前运行**。 有关详细信息，请参阅[ECID文档](https://experienceleague.adobe.com/docs/id-service/using/home.html)。 唯一的其他先决条件与代码版本有关，因此，由于您只需按以下步骤应用代码的最新版本，因此您不会有任何问题。
